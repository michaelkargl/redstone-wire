...
- [ ] #5 getTicker() returns RedstoneChainEntity::tick for periodic updates
- [ ] #6 onPlace() triggers initial signal detection
<!-- AC:END -->
...
- [ ] #8 `getTicker()` returns `RedstoneChainEntity::tick` (overrides base null)
- [ ] #9 `onPlace()` schedules entity update via `level.scheduleTick(pos, this, 1)` or direct call

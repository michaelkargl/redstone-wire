...
- [x] #2 Has POWER property (0-15) with default state POWER=0
- [x] #3 isSignalSource() returns false, getSignal() returns 0, getDirectSignal() returns 0
- [x] #4 Comparator can read the input signal level via getAnalogOutputSignal()
  - isSignalSource() defaults to `false`
- [ ] #5 onPlace() triggers initial signal detection
<!-- AC:END -->

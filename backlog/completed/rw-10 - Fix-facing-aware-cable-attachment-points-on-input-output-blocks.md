...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Cables on input blocks visually originate from the antennae tip for all 4 FACING directions
- [x] #2 Cables on output blocks visually originate from the antennae tip for all 4 FACING directions
- [x] #3 Output renderer regression (wrong BlockSize constant divisor and incomplete `var anntenae` line) is removed
- [x] #4 Y attachment heights match current model geometry: input = 9/16, output = 7/16
<!-- AC:END -->

...
public class RedstoneChainConnector extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            CompoundTag tag = stack.getOrDefault(ModDataComponents.CONNECTOR_LINK_DATA, new CompoundTag());
            if (tag.contains("LinkX")) {
                CompoundTag newTag = tag.copy();
                newTag.remove("LinkX");
                newTag.remove("LinkY");
                newTag.remove("LinkZ");
                stack.set(ModDataComponents.CONNECTOR_LINK_DATA, newTag.isEmpty() ? null : newTag);
    ...
    (Level level, Player player, BlockPos clickedPos,
        ...
        CompoundTag savedData = stack.getOrDefault(ModDataComponents.CONNECTOR_LINK_DATA, new CompoundTag());
    ...
    private void savePositionToItem(ItemStack stack, BlockPos pos) {
        ...
        stack.set(ModDataComponents.CONNECTOR_LINK_DATA, tag);
    }
